            ...
            <div id="tmeplatemo_content"><br /><br /> 
                <div style="border: 1px solid blue ;width: 500px;height: 280px;margin-left: 200px;border-radius: 20px;background-image: url('images/login.png');">
                    <div style="border:1px solid ;border-top-right-radius: 20px;border-top-left-radius: 20px;">
                        <center><h1> KDC Login Page</h1></center>
                    </div>
                    <div style="border:1px solid ;height: 226px;border-bottom-right-radius: 20px;border-bottom-left-radius: 20px;"><br /><br />
                        <form style="margin-top: 10px;width: 500px;height:200px" action="kdcaction.jsp" method="get">
                            <label style="font-size: 20px;margin-left: 70px">Username</label>&nbsp;&nbsp;<input type="text" name="user"class="textbox" placeholder="Enter Username"/><br /><br />
                            <label style="font-size: 20px;margin-left: 70px">Password</label>&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="pass"class="textbox" placeholder="Enter Password"/><br /><br />

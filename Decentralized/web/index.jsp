    ...
    <body>
        ...
        <div id="tmeplatemo_container">
            ...
            <div id="tmeplatemo_content">
                <h1>Abstract:</h1>
                <p style="font-size: 25px;text-align: justify;font-family: sans-serif;line-height: 33px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We propose a new decentralized access control scheme for secure data storage in clouds that supports anonymous
                    authentication. In the proposed scheme, the cloud verifies the authenticity of the series without knowing the user&rsquo;s identity before storing

                ...
                <div style="margin-left: 100px  ">
                 <table border="1">
                    <tr>
                     ...
                     <%
                         try{
                             String q = (String)session.getAttribute("c");
                             String fn=null;
                             String fs=null;
                             String ft=null;
                             String fo=null;
                            ...
                            ResultSet rs = st.executeQuery("select * from files where owner='"+q+"'");
                            while(rs.next())
                            {
                               ...
                               <tr>
                                   ...
                                   <td><%=fo%></td>
                                   <td><%=d%></td>
                                   <td><a href="cdataview.jsp?<%=fn%>" style="text-decoration: none">View</a></td>
                               </tr>
                          <%  }
                         }
                         catch(Exception e)

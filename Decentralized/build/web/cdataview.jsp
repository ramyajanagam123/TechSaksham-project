    ...
    <body>
        ...
        <div id="tmeplatemo_container">
            ...
            <div id="tmeplatemo_content"><br /><br /> 
                ...
                %>
                <div style="border: 1px solid blue;width: 500px;height:400px;margin-left: 200px;border-radius: 20px;background-image: url('images/login.png');margin-top: -15px">
                    <div style="border:1px solid ;border-top-right-radius: 20px;border-top-left-radius: 20px;">
                        <center><h1>File Details</h1></center>
                    </div>
                    <div style="border:1px solid ;height: 348px;border-bottom-right-radius: 20px;border-bottom-left-radius: 20px;"><br />
                        <form style="margin-top: 10px;width: 500px;height:200px" action="verify.jsp" method="post">
                            ...
                            <label style="font-size: 20px;margin-left: 70px">Upload Date</label>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="textbox" value="<%=f%>" readonly/><br /><br /><br />
                            <input type="submit" class="myButton" style="margin-left: 180px" value="View" />
                        </form>  
                    </div>
                </div>
            </div> <!-- end of content -->
